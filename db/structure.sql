...
COMMENT ON TABLE public.sip_grupoper IS 'Creado por sip en jn635pdJ_desarrollo';
...
--
-- Name: usuario fk_rails_9bba971b11; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.usuario
    ADD CONSTRAINT fk_rails_9bba971b11 FOREIGN KEY (clase_id) REFERENCES public.sip_clase(id);
...
--
-- Name: usuario fk_rails_d7e1e4bac8; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.usuario
    ADD CONSTRAINT fk_rails_d7e1e4bac8 FOREIGN KEY (municipio_id) REFERENCES public.sip_municipio(id);


--
-- Name: usuario fk_rails_de3f360b54; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.usuario
    ADD CONSTRAINT fk_rails_de3f360b54 FOREIGN KEY (departamento_id) REFERENCES public.sip_departamento(id);
